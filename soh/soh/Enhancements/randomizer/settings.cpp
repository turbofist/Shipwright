...
void Settings::CreateOptions() {
    ...
    mOptions[RSK_SHUFFLE_TREES] = Option::U8("Shuffle Trees", {"Off", "On"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("SuffleTrees"), mOptionDescriptions[RSK_SHUFFLE_TREES], WidgetType::Combobox, RO_SHUFFLE_TREES_OFF);
